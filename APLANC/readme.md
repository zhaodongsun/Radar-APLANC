...
Our [RHB](https://1drv.ms/f/c/0591660FD4399B1C/EksQUXkPAOdJgKwigtyDoBEBXygc7oa6P2hK5iDhbPTjxA?e=cTNtsc) dataset maintains the same data format as the Equipleth dataset and is processed using `organizer.py`. If you want to use your own dataset or other datasets, please replace `organizer.py`.
